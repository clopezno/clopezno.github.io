...
var clozeeditorDialog = {
    ...
    insert: function() {
      ...
      top.tinymce.activeEditor.execCommand('mceInsertContent', false, encode() + " ");
...
/*
 if (typeof(top.tinymce) != "undefined") {
    top.tinymce.onInit.add(clozeeditorDialog.init, clozeeditorDialog);
}
 */