tinymce.PluginManager.add("codehl", function(t, e) {
    ...
    t.addButton("codehl", {title: "Format Code", image: e + '/img/codehl.gif', onclick: cmdcodehl}),
    t.addMenuItem("codehl", {text: "Format Code", image: e + '/img/codehl.gif', context: "tools", onclick: cmdcodehl}),
    t.addButton("clozeexport", {title: "Export CLOZE questions", image: e + '/img/codehle.gif', onclick: clozeExport},
    t.addMenuItem("clozeexport", {text: "Export CLOZE questions", image: e + '/img/codehle.gif', context: "tools", onclick: clozeExport}));
});